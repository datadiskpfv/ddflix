...
INSERT INTO discs(id, disc_format, in_stock, film_id, date_created, last_updated) VALUES
  ...
  (6, 'Blu-Ray', true, 2, sysdate(), sysdate()),
  (7, 'Blu-Ray', true, 3, sysdate(), sysdate()),
  (8, 'Blu-Ray', true, 4, sysdate(), sysdate()),
  (9, 'Blu-Ray', true, 5, sysdate(), sysdate()),
  (10, 'Blu-Ray', true, 6, sysdate(), sysdate()),
  (11, 'Blu-Ray', true, 7, sysdate(), sysdate()),
  (12, 'Blu-Ray', true, 8, sysdate(), sysdate()),
  (13, 'Blu-Ray', true, 9, sysdate(), sysdate()),
  (14, 'Blu-Ray', true, 10, sysdate(), sysdate()),
  (15, 'Blu-Ray', true, 11, sysdate(), sysdate()),
  (16, 'Blu-Ray', true, 12, sysdate(), sysdate()),
  (17, 'Blu-Ray', true, 13, sysdate(), sysdate()),
  (18, 'Blu-Ray', true, 14, sysdate(), sysdate()),
  (19, 'Blu-Ray', true, 15, sysdate(), sysdate()),
  (20, 'Blu-Ray', true, 16, sysdate(), sysdate()),
  (21, 'Blu-Ray', true, 17, sysdate(), sysdate()),
  (22, 'Blu-Ray', true, 18, sysdate(), sysdate()),
  (23, 'Blu-Ray', true, 19, sysdate(), sysdate()),
  (24, 'Blu-Ray', true, 20, sysdate(), sysdate()),
  (25, 'Blu-Ray', true, 21, sysdate(), sysdate()),
  (26, 'Blu-Ray', true, 22, sysdate(), sysdate()),
  (27, 'Blu-Ray', true, 23, sysdate(), sysdate()),
  (28, 'Blu-Ray', true, 24, sysdate(), sysdate()),
  (29, 'Blu-Ray', true, 25, sysdate(), sysdate()),
  (30, 'DVD', true, 6, sysdate(), sysdate()),
  (31, 'DVD', true, 7, sysdate(), sysdate()),
  (32, 'DVD', true, 8, sysdate(), sysdate()),
  (33, 'DVD', true, 9, sysdate(), sysdate()),
  (34, 'DVD', true, 10, sysdate(), sysdate()),
  (35, 'DVD', true, 11, sysdate(), sysdate()),
  (36, 'DVD', true, 12, sysdate(), sysdate()),
  (37, 'DVD', true, 13, sysdate(), sysdate()),
  (38, 'DVD', true, 14, sysdate(), sysdate()),
  (39, 'DVD', true, 15, sysdate(), sysdate()),
  (40, 'DVD', true, 16, sysdate(), sysdate()),
  (41, 'DVD', true, 17, sysdate(), sysdate()),
  (42, 'DVD', true, 18, sysdate(), sysdate()),
  (43, 'DVD', true, 19, sysdate(), sysdate()),
  (44, 'DVD', true, 20, sysdate(), sysdate()),
  (45, 'DVD', true, 21, sysdate(), sysdate()),
  (46, 'DVD', true, 22, sysdate(), sysdate()),
  (47, 'DVD', true, 23, sysdate(), sysdate()),
  (48, 'DVD', true, 24, sysdate(), sysdate()),
  (49, 'DVD', true, 25, sysdate(), sysdate());
